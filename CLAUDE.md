...
- **uniapp-x-playground**: Uni-App X project that serves as a testbed for the native plugin
- **android-playground**: Android Studio project containing the native Android implementation
- **ios-framework**: Xcode project containing the native iOS implementation
...
```bash
# Open HBuilderX and import the uniapp-x-playground directory
...
#### iOS Framework
```bash
# Open ios-framework.xcodeproj in Xcode
# Select ios-framework scheme and build
```
...
- **Interface Definition**: `uni_modules/say-hi/utssdk/interface.uts` - TypeScript interface definitions
- **Android Implementation**: `uni_modules/say-hi/utssdk/app-android/index.uts` - Android-specific implementation
- **iOS Implementation**: `uni_modules/say-hi/utssdk/app-ios/index.uts` - iOS-specific implementation
- **Native Libraries**: 
  - Android: `android-playground/android-lib/src/main/java/com/hens/android_lib/SayHiLib.kt`
  - iOS: `ios-framework/ios-framework/ios_framework.swift`

### Configuration Files
- **Android**: `uni_modules/say-hi/utssdk/app-android/config.json` - Android SDK version config
- **iOS**: `uni_modules/say-hi/utssdk/app-ios/config.json` - iOS deployment target config
...
The main testing interface is in `uniapp-x-playground/pages/index/index.uvue` which provides a UI to test the plugin functionality. The plugin supports both sync and async calls through the UTS bridge.
