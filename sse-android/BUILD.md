...
```bash
./gradlew :sse-lib:assembleDebug    # 构建 debug 版本
./gradlew :sse-lib:assembleRelease  # 构建 release 版本
...
构建完成后，AAR 文件将生成在：
```
sse-android/sse-lib/build/outputs/aar/
├── sse-lib-debug.aar      # Debug 版本
├── sse-lib-release.aar    # Release 版本
└── sse-lib-release.aar    # Release-minified 版本 (混淆后)
```
...
- [Android 库开发](https://developer.android.com/studio/projects/sse-library)
